/**
 * BlinkerDockTilePlugin - NSDockTilePlugIn implementation
 *
...
static NSString * const BlinkerDockTileUpdateNotification = @"dev.lovly.blinker.dock-tile.update";

@interface BlinkerDockTilePlugin : NSObject <NSDockTilePlugIn>
@property (nonatomic, strong) NSDockTile *dockTile;
 - (void)handleDockTileUpdate:(NSNotification *)notification;
 - (void)updateDockTile;
@end

@implementation BlinkerDockTilePlugin
...
- (void)setDockTile:(NSDockTile *)dockTile {
    ...
    [center addObserver:self
               selector:@selector(handleDockTileUpdate:)
                   name:BlinkerDockTileUpdateNotification
                 object:nil
