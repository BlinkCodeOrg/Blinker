...
The Extensions API provides functionalities for working with browser extensions in Blinker Browser. This document serves as an index to the available extension-related APIs.
